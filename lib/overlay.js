...
// ----------------------------------------------------------------------------
// (Sacado, set. 2026, pedido de Andrea): antes aca vivia una subcategoria
// manual POR COMENTARIO (no_asignable/asignable_alerta/asignable) que se
// sumaba a las reglas de color de lib/elegibilidad.js. Se reemplazo por un
// 5to valor en el Estado del perfil ('alerta'), que cubre el mismo caso a
// nivel de toda la persona en vez de comentario por comentario - mas simple
// de mantener. Si hace falta el historial, esta en el control de versiones.
// ----------------------------------------------------------------------------
