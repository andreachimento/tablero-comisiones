...
//
// Variantes de tag que existen hoy en la base de staff: profesor (290),
// profesora (144), tutor (142), tutora (113), professor (2), tutoral (1), y 5
// cuentas sin ningun tag. Por eso se compara por prefijo y no por igualdad.
function rolPorEmail(email) {
  ...
  if (/^profe/.test(tag)) return 'PROFESOR';
  return null;
}
